...
function verifyUser() {
    localStorage.getItem("user") ? loginArea.style.display = "none" : accountArea.style.display = "none";
...
loginData.addEventListener("submit", (event)=>{
    ...
    if (email.value === accountEmail && password.value === accountPassword) loginUser(email, password);
...
function bankCalculateBalance(type, formId, typeField, typeAmount, balanceAmount) {
    document.getElementById(formId).addEventListener("submit", (e)=>{
        ...
        if (inputValue <= 0 || !inputValue) {
            type === "deposit" ? alert(`Please Add Your Deposit Amount!`) : alert(`Please Widthdraw Your Amount!`);
            inputValue = "";
            return;
            ...
            const balanceAmountTotal = type === "deposit" ? balanceAmountValue + inputValue : balanceAmountValue - inputValue;
...
bankCalculateBalance("deposit", "depositForm", "deposit-field", "depositAmount", "balanceAmount");
bankCalculateBalance("widthdraw", "widthdrawForm", "widthdraw-field", "widthdrawAmount", "balanceAmount");

},{}]},["7ZoMj","8lRBv"], "8lRBv", "parcelRequire05de")
